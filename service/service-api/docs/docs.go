...
// 2019-03-02 23:06:59.858663 +0800 CST m=+0.087406941
    ...
    "paths": {
        ...
        "/exchange/getKlineRecords": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "每个参数均不得为空,period:0-\u003e1min,1-\u003e5min,2-\u003e15min,3-\u003e30min,4-\u003e60min,5-\u003e1d,6-\u003e1week,7-\u003e1mon,8-\u003e1year",
                        "name": "group",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/model.TraderStatus"
                        }
                    }
                ],
                "responses": {
